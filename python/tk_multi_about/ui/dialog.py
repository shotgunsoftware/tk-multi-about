...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(QtGui.QApplication.translate("Dialog", "Current Context lists all SG objects that together make up the Current Work Area. Double-click an item to access the object in SG.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_3.setText(QtGui.QApplication.translate("Dialog", "The Environment file contains all settings and configurations for currently running SG apps. The Engine provides core services, such as menu management and app startup.", None, QtGui.QApplication.UnicodeUTF8))
