...
class AppDialog(QtGui.QWidget):
    def __init__(self, app):
        ...
        self.ui.environment_browser.action_requested.connect(
            self.show_engine_in_app_store
        )
    ...
    def show_in_fs(self):
        ...
        for disk_location in paths:
            if not QtGui.QDesktopServices.openUrl("file://{0}".format(disk_location).replace("\\", "/")):
